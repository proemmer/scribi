...
namespace Scribi.Services
{
    ...
    public class CyclicExecutorService : ICyclicExecutorService
    {
        private class Execution
        {
            ...
            public Execution(string aName, string aLabel, double aMilliseconds, Action aMethod, bool aAsThread = false, bool aSingleRun = false)
            {
                _name = aName;
                Label = aLabel;
        ...
        public void Update(string name, double milliseconds)
        {
            _timersRWLock.EnterReadLock();
            try
            {
        ...
        public void Add(string name, string label, double milliseconds, Action action, bool enabled = false, bool ownThread = false, bool executeOnlyOnce = false)
        {
